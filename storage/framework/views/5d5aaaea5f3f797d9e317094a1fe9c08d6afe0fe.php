                    ...
                    <div class="container blue-header-nav">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            ...
                            <div class="top-right links">
                                ...
                                <a class="menuRight" href="<?php echo e(url('/login')); ?>">Iniciar Sesión</a>
                                <a class="menuRight" href="<?php echo e(url('/register')); ?>">Registro</a>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 centered">
                    <div class="convo-wrapper">
                        ...
                        <img class="" src="images/campañas/ecofest-voluntariado.jpg" alt="Generic placeholder image" width="290" height="230"/><br><br>
                ...
                <div class="col-lg-4 centered">
                    <div class="convo-wrapper">
                        ...
                        <img class="" src="images/campañas/ecofest.jpg" width="290" height="230"><br><br>
                        <div class="convo-body">
            ...
            <div class="row">
                <div class="col-lg-4 centered">
                    <div class="convo-wrapper-closed">
                        ...
                        <img class="element-closed" src="images/campañas/induccion.jpg" alt="Generic placeholder image" width="290" height="230" /><br><br>
                        <div class="convo-body">
